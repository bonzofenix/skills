...
- **Other repos**: per-repo merge quirks (known flaky checks, ruleset toggles)
  live in the user's memory, not here. Check it before treating a red check as
  a real failure, and ask before touching any ruleset.
